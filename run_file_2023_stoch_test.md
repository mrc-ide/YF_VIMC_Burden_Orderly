...
scenarios = c("routine-default","no-vaccination")
...
for(n_run in 1:length(scenarios)){
  ...
  country_list_file = paste0(path, "/shared/countries_select.csv"), 
  ...
  cfr_data_file = paste0(path, "/shared/P_severe_severeDeath_new_2_values.Rds"), 
