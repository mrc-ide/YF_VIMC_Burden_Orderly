...
orderly2::orderly_artefact(description = "scenario name", files="scenario_name.Rds" )
orderly2::orderly_artefact(description = "country input data", files="input_data_countries.Rds" )
orderly2::orderly_artefact(description = "FOI and R0 median values", files="FOI_R0_med_countries.Rds" )
orderly2::orderly_artefact(description = "FOI and R0 values", files="FOI_R0_countries.Rds" )
orderly2::orderly_artefact(description = "vaccine efficacy median value", files="vaccine_efficacy_med.Rds" )
orderly2::orderly_artefact(description = "vaccine efficacy values", files="vaccine_efficacy.Rds" )
orderly2::orderly_artefact(description = "severe infection rate median value",files="p_severe_inf_median.Rds")
orderly2::orderly_artefact(description = "severe infection death rate median value",
                           files="p_death_severe_inf_median.Rds")
...
assertthat::assert_that(all(countries_select==sort(countries_select)))
...
if("country_code" %in% colnames(pop_data) == FALSE){pop_data$country_code=pop_data$country}
